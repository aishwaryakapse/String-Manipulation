 ...
 */
public class SearchRotatedSortedI {
	...
	public static void main(String[] args) {
		SearchRotatedSortedI sr1 = new SearchRotatedSortedI();
		int[] nums = {5, 6, 7, 0, 1, 2, 3, 4};
		int target = 2;
		System.out.println(sr1.search(nums, target));
		System.out.println(sr1.searchIter(nums, target));
	}
}
